...
4. Deploy the policies in **Audit only** mode, you need several versions for Windows 10 and 11. The deployment details is here. [AppLocker Deployment details](https://github.com/Penguinsecq/penguinsecq.github.io/blob/main/docs/acsc-essential-eight/applocker-deployment-steps.md)
