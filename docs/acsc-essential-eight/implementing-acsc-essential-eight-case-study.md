...
I started conducting the assessment on all in-scoped system by reviewing the existence of processes, effectiveness of controls, documents and reports, etc. Any assessment evidences, limitataions, screenshots and constraints on testing were documented within the excel file, and official assessment report in Word and PDF format in the end. I utilised 
